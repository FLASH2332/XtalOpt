...
struct qt_meta_stringdata_XtalOpt__TabLog_t {
    QByteArrayData data[5];
    char stringdata0[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_XtalOpt__TabLog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_XtalOpt__TabLog_t qt_meta_stringdata_XtalOpt__TabLog = {
    {
QT_MOC_LITERAL(0, 0, 15), // "XtalOpt::TabLog"
QT_MOC_LITERAL(1, 16, 13), // "disconnectGUI"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 6), // "newLog"
QT_MOC_LITERAL(4, 38, 4) // "info"

    },
    "XtalOpt::TabLog\0disconnectGUI\0\0newLog\0"
    "info"
};
...
QT_INIT_METAOBJECT const QMetaObject XtalOpt::TabLog::staticMetaObject = { {
    QMetaObject::SuperData::link<GlobalSearch::AbstractTab::staticMetaObject>(),
    qt_meta_stringdata_XtalOpt__TabLog.data,
    qt_meta_data_XtalOpt__TabLog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *XtalOpt::TabLog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_XtalOpt__TabLog.stringdata0))
