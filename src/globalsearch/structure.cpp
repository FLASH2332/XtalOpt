...
Structure& Structure::operator=(const Structure& other)
{
  if (this != &other) {
    ...
    m_compositionGroupIndex = other.m_compositionGroupIndex;
  }
...
Structure& Structure::operator=(Structure&& other) noexcept
{
  if (this != &other) {
    ...
    m_compositionGroupIndex = std::move(other.m_compositionGroupIndex);
  }
...
void Structure::writeStructureSettings(const QString& filename)
{
  ...
  settings->setValue("compositionGroupIndex", compositionGroupIndex());
                                      ...
                                      const bool readCurrentInfo)
{
  ...
  if (loadedVersion >= 1) { // Version 0 uses save(QTextStream)
    ...
    setCompositionGroupIndex(settings->value("compositionGroupIndex", -1).toInt());
