...
public:
    ...
    void setupUi(QDialog *SgeConfigDialog)
    {
        ...
        SgeConfigDialog->resize(700, 500);
        ...
        label_4 = new QLabel(SgeConfigDialog);
        ...
        widget_globalQueueInterfaceSettings = new GlobalSearch::GlobalQueueInterfaceSettingsWidget(SgeConfigDialog);
    ...
    {
        SgeConfigDialog->setWindowTitle(QCoreApplication::translate("SgeConfigDialog", "SGE Queue Configuration", nullptr));
#if QT_CONFIG(tooltip)
        label_launch->setToolTip(QCoreApplication::translate("SgeConfigDialog", "Command used to submit jobs to the SGE queue. Usually qsub.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_launch->setText(QCoreApplication::translate("SgeConfigDialog", "Path to qsub:", nullptr));
#if QT_CONFIG(tooltip)
        edit_qsub->setToolTip(QCoreApplication::translate("SgeConfigDialog", "Command used to submit jobs to the SGE queue. Usually qsub.", nullptr));
#endif // QT_CONFIG(tooltip)
        edit_qsub->setText(QCoreApplication::translate("SgeConfigDialog", "qsub", nullptr));
#if QT_CONFIG(tooltip)
        label_qdel->setToolTip(QCoreApplication::translate("SgeConfigDialog", "Command used to delete jobs from the queue. Usually qdel.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_qdel->setText(QCoreApplication::translate("SgeConfigDialog", "Path to qdel:", nullptr));
#if QT_CONFIG(tooltip)
        edit_qstat->setToolTip(QCoreApplication::translate("SgeConfigDialog", "Command used to check the SGE queue. Use qstat.", nullptr));
#endif // QT_CONFIG(tooltip)
        edit_qstat->setText(QCoreApplication::translate("SgeConfigDialog", "qstat", nullptr));
#if QT_CONFIG(tooltip)
        label_check->setToolTip(QCoreApplication::translate("SgeConfigDialog", "Command used to check the SGE queue. Use qstat.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_check->setText(QCoreApplication::translate("SgeConfigDialog", "Path to qstat:", nullptr));
#if QT_CONFIG(tooltip)
        edit_qdel->setToolTip(QCoreApplication::translate("SgeConfigDialog", "Command used to delete jobs from the queue. Usually qdel.", nullptr));
#endif // QT_CONFIG(tooltip)
        edit_qdel->setText(QCoreApplication::translate("SgeConfigDialog", "qdel", nullptr));
        label_4->setText(QCoreApplication::translate("SgeConfigDialog", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Step Queue Interface Settings</span></p></body></html>", nullptr));
    } // retranslateUi
