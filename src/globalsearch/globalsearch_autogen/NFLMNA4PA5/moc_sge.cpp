...
struct qt_meta_stringdata_GlobalSearch__SgeQueueInterface_t {
    QByteArrayData data[11];
    char stringdata0[137];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GlobalSearch__SgeQueueInterface_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GlobalSearch__SgeQueueInterface_t qt_meta_stringdata_GlobalSearch__SgeQueueInterface = {
    {
QT_MOC_LITERAL(0, 0, 31), // "GlobalSearch::SgeQueueInterface"
...
void GlobalSearch::SgeQueueInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SgeQueueInterface *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GlobalSearch::SgeQueueInterface::staticMetaObject = { {
    QMetaObject::SuperData::link<RemoteQueueInterface::staticMetaObject>(),
    qt_meta_stringdata_GlobalSearch__SgeQueueInterface.data,
    qt_meta_data_GlobalSearch__SgeQueueInterface,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GlobalSearch::SgeQueueInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GlobalSearch__SgeQueueInterface.stringdata0))
